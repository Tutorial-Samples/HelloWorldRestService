...
FROM maven:3.6.3-jdk-11 as hello-world
WORKDIR /hello-world
...
COPY --from=hello-world ${DEPENDENCY}/BOOT-INF/lib /app/lib
COPY --from=hello-world ${DEPENDENCY}/META-INF /app/META-INF
COPY --from=hello-world ${DEPENDENCY}/BOOT-INF/classes /app
